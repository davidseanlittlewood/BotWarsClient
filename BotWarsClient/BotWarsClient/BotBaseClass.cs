...
namespace BotWarsClient
{
    ...
    public abstract class BotBaseClass
    {
        ...
        /// 
        /// POST http://<your_bot_url>/flipped
        /// </summary>
        ...
        /// <summary>
        /// An update sent to your bot to alert you if your opponent has been flipped onto your back
        /// 
        /// Method called when status instruction is received instructing          
        /// 
        /// POST http://<your_bot_url>/opponentflipped
        /// </summary>
        /// <param name="flipped">A bool indicating whether or not you have been flipped</param>
